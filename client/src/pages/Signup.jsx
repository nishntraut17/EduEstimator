...
const Signup = () => {
    ...
    return (
        <div className="mx-auto max-w-lg">
            <div className='text-2xl text-gray-700 font-bold my-10'>Signup</div>
            <form onSubmit={handleSubmit} className="space-y-4 flex flex-col gap-4">
                <input type="text" name="username" value={formData.username} onChange={handleChange} placeholder="Name" className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" />
